    ...
    class oe {
        constructor() {
           ...
           new he(304, "Technical Think Tank", this.constructionTypes.TechThinkTank, {
                ...
                this.upgrades = [new le(1, "Bloodthirst", this.types.damage, this.costs.blood, 50, 1.2, 1, 40, "Your zombies thirst for blood and do +1 damage for each rank of Bloodthirst.", null, null),
                                 ...
                                 new le(74, "Strider's Mathemagics", this.types.SkeleMove, this.costs.parts, 1e18, 6, .1, 10, "Using Archane Mathemagics you imbue your Skeleton Champion with golem based ligaments. +1 Movement Speed per rank.(In tests)", null, 304)],      
        ...
        applyUpgrade(e, t) {
            switch (e.type) {
                ...
                case this.types.SkeleMove:
                    return void (this.skeleton.moveSpeed += e.effect * t);
        ...
        displayStatValue(e) {
            switch (e.type) {
                ...
                case this.types.SkeleMove:
                    return "Skeleton speed: " + n(this.skeleton.moveSpeed);
                case this.types.ShockPC:
