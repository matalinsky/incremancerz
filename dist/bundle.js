        ...
        constructor() {
           ...
           new he(304, "Technical Think Tank", this.constructionTypes.TechThinkTank, {
                ...
                this.upgrades = [new le(1, "Bloodthirst", this.types.damage, this.costs.blood, 50, 1.2, 1, 40, "Your zombies thirst for blood and do +1 damage for each rank of Bloodthirst.", null, null),
                                 ...
                                 new le(64, "Advanced Cyrogenic Vats", this.types.CyroVatPC, this.costs.parts, 1e3, (1 + (0.40 * Math.pow(this.persistent.level, 2))), .1, 0, "Cooling these Brains further makes them last much longer. Your brain storage increases +10% with each rank of Advanced Cyrogenic Vats.", null, 302),
