...
(() => {
        ...
        constructor() {
           ...
           new he(304, "Technical Think Tank", this.constructionTypes.TechThinkTank, {
                ...
                this.upgrades = [new le(1, "Bloodthirst", this.types.damage, this.costs.blood, 50, 1.2, 1, 40, "Your zombies thirst for blood and do +1 damage for each rank of Bloodthirst.", null, null),
                                 ...
                                 new le(71, "Electro-Shock Collars", this.types.ShockPC, this.costs.parts, 3e14, 1.20, .0025, 0, "Using shock collars tuned to the Hybrid Zombie's nervous system causes them to attack and blinding speeds! Attack Speed +0.25% with each rank of Electro-Shock Collars.", null, 304),
    ...
    St.forEach((e => {
        ...
        c.model = ne.getInstance(), c.skeleton = function () {
            ...
            anotherOffer: () => i.persistent.skeletons > 0 && c.model.persistentData.trophies.length >= (i.persistent.xpRate < 15 ? 20 * i.persistent.xpRate : 80 + (Math.log2(i.persistent.xpRate)-3) * 80),
            trophies: () => i.persistent.skeletons > 0 ? ` - ${c.model.persistentData.trophies.length} / ${i.persistent.xpRate < 15 ? 20 * i.persistent.xpRate : 80 + (Math.log2(i.persistent.xpRate)-3) * 80 } Trophies` : "",
