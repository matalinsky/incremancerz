...
(() => {
        ...
        constructor() {
           ...
           new he(304, "Technical Think Tank", this.constructionTypes.TechThinkTank, {
                ...
                this.upgrades = [new le(1, "Bloodthirst", this.types.damage, this.costs.blood, 50, 1.2, 1, 40, "Your zombies thirst for blood and do +1 damage for each rank of Bloodthirst.", null, null),
                                 ...
                                 new le(65, "Golem Part Plague Vats", this.types.PlagueVatPC, this.costs.brains, 1e3, 1.40, .01, 0, "Using specialized Golem Parts allows for advancements in plague research. Plague Damage increases +1% with each rank of Golem Part Plague Vats.", null, 302),
    ...
    class Se {
        ...
        getMaxHealth(e) {
            return e < 7 ? 10 * (e + 4) : e < 12 ? 20 * (e - 1) : e < 16 ? 25 * (e - 3) : e < 29 ? 50 * (e - 9) : e < 49 ? 100 * (e - 19) : e < 64 ? 300 * (e - 39) : e < 85 ? 500 * (e - 49) : e < 499 ? 17800 * Math.pow(1.015, e - 84) : e < 999 ? 85e5 * Math.pow(1.03, e - 499) : e > 1499 ? 498e16 * Math.pow(1.021, e - 1499) : 22e12 * Math.pow(1.025, e - 999)
        }
        getAttackDamage() {
